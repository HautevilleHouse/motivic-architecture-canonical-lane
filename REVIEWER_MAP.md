...
6. Scalar closure: `MOT_G1`, `MOT_G2`, `MOT_G3`, `MOT_G4`, `MOT_G5`, `MOT_G6`, `MOT_GM` all `PASS`.

Primary files:

- `paper/MOTIVIC_ARCHITECTURE_PREPRINT.md`
- `notes/EG1_public.md`
- `notes/EG2_public.md`
- `notes/EG3_public.md`
- `notes/EG4_public.md`
...
| `MOT_G6` | `eps_coh` | strict coherence / identification closure |
| `MOT_GM` | derived | final strict margin |
