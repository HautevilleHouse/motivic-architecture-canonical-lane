...
Canonical Lane super-repo for a flagship umbrella problem in motives, cohomology, and arithmetic geometry:
proving persistence of the declared motivic realization and filtration package across admissible correspondence transport through a multi-lane motivic super-architecture.
...
- [paper/MOTIVIC_ARCHITECTURE_PREPRINT.md](paper/MOTIVIC_ARCHITECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `MOTIVIC_ARCHITECTURE_PREPRINT.md`
...
1. Super-lane theorem chain first: read `paper/MOTIVIC_ARCHITECTURE_PREPRINT.md`.
...
Current MOT runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/mot_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/mot_closure_guard.py`.
...
- Manuscript target: [paper/MOTIVIC_ARCHITECTURE_PREPRINT.md](paper/MOTIVIC_ARCHITECTURE_PREPRINT.md)
