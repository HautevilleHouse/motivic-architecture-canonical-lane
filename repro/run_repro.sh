...
mkdir -p .repro_tmp/motivic_architecture
cp artifacts/stitch_constants.json .repro_tmp/motivic_architecture/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/motivic_architecture/constants_registry.json
