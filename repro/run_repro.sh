...
mkdir -p .tmp/motivic_architecture
cp artifacts/stitch_constants.json .tmp/motivic_architecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/motivic_architecture/constants_registry.json
